...
/**
 * This class manages the CUR_DEPTH_QUALITY table with the help of the DbAccessC
 ...
 */
public class CurDepthQuality extends Tables {
    ...
    /** The table name */
    public static final String TABLE = "CUR_DEPTH_QUALITY";
     ...
     */
    public CurDepthQuality() {
        clearVars();
        if (dbg) System.out.println ("<br>in CurDepthQuality constructor 1"); // debug
    } // CurDepthQuality constructor

    /**
     * Instantiate a CurDepthQuality object and initialize the instance variables.
    ...
    public CurDepthQuality(
        ...
        if (dbg) System.out.println ("<br>in CurDepthQuality constructor 2"); // debug
    } // CurDepthQuality constructor
    ...
    public CurDepthQuality(
        ...
        setNotes          (notes         );
        if (dbg) System.out.println ("<br>in CurDepthQuality constructor 3"); // debug
    } // CurDepthQuality constructor
     ...
     * are returned in an array of CurDepthQuality. e.g.<pre>
     * CurDepthQuality curDepthQuality = new CurDepthQuality(<val1>);
     * CurDepthQuality curDepthQualityArray[] = curDepthQuality.get();</pre>
     * will get the CurDepthQuality record where depthCode = <val1>.
     * @return Array of CurDepthQuality (CurDepthQuality[])
     */
    public CurDepthQuality[] get() {
     ...
     * e.g.<pre>
     * CurDepthQuality curDepthQualityArray[] =
     *     new CurDepthQuality().get(CurDepthQuality.DEPTH_CODE+"=<val1>");</pre>
     * will get the CurDepthQuality record where depthCode = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of CurDepthQuality (CurDepthQuality[])
     */
    public CurDepthQuality[] get (String where) {
     ...
     * CurDepthQuality curDepthQualityArray[] =
     *     new CurDepthQuality().get("1=1",curDepthQuality.DEPTH_CODE);</pre>
     * will get the all the CurDepthQuality records, and order them by depthCode.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of CurDepthQuality (CurDepthQuality[])
     */
    public CurDepthQuality[] get (String where, String order) {
     ...
     * String columns = CurDepthQuality.DEPTH_CODE,CurDepthQuality.SEQUENCE_NUMBER;
     * String where = CurDepthQuality.DEPTH_CODE + "=<val1";
     * String order = CurDepthQuality.DEPTH_CODE;
     * CurDepthQuality curDepthQualityArray[] =
     *     new CurDepthQuality().get(columns, where, order);</pre>
     * will get the depthCode and sequenceNumber colums of all CurDepthQuality records,
     ...
     * @return Array of CurDepthQuality (CurDepthQuality[])
     */
    public CurDepthQuality[] get (String fields, String where, String order) {
     ...
     * and transforms it into an array of CurDepthQuality.
     * @param  result  (Vector (rows) of Vectors (columns)).
     */
    private CurDepthQuality[] doGet(Vector result) {
        ...
        CurDepthQuality[] cArray = new CurDepthQuality[result.size()];
        for (int i = 0; i < result.size(); i++) {
            Vector row = (Vector) result.elementAt(i);
            cArray[i] = new CurDepthQuality();
            if (depthCodeCol != -1)
     ...
     * Boolean success = new CurDepthQuality(
     *     Tables.INTNULL,
     *     <val2>,
     ...
     *  .e.g.<pre>
     * Boolean success
     * CurDepthQuality curDepthQuality = new CurDepthQuality();
     * success = curDepthQuality.del(CurDepthQuality.DEPTH_CODE+"=<val1>");</pre>
     ...
     * update are taken from the CurDepthQuality argument, .e.g.<pre>
     * Boolean success
     * CurDepthQuality updCurDepthQuality = new CurDepthQuality();
     * updCurDepthQuality.setSequenceNumber(<val2>);
     * CurDepthQuality whereCurDepthQuality = new CurDepthQuality(<val1>);
     * success = whereCurDepthQuality.upd(updCurDepthQuality);</pre>
     * will update SequenceNumber to <val2> for all records where
     * depthCode = <val1>.
     * @param  curDepthQuality  A CurDepthQuality variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(CurDepthQuality curDepthQuality) {
        return db.update (TABLE, createColVals(curDepthQuality), createWhere());
    } // method upd
     ...
     * CurDepthQuality updCurDepthQuality = new CurDepthQuality();
     * updCurDepthQuality.setSequenceNumber(<val2>);
     * CurDepthQuality whereCurDepthQuality = new CurDepthQuality();
     * success = whereCurDepthQuality.upd(
     *     updCurDepthQuality, CurDepthQuality.DEPTH_CODE+"=<val1>");</pre>
     * will update SequenceNumber to <val2> for all records where
     * depthCode = <val1>.
     * @param  curDepthQuality  A CurDepthQuality variable in which the fields are to be used for
     *                 the update are set
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(CurDepthQuality curDepthQuality, String where) {
        return db.update (TABLE, createColVals(curDepthQuality), where);
    } // method upd
     ...
     */
    private String createColVals(CurDepthQuality aVar) {
        String colVals = "";
