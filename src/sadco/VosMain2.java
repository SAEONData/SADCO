//+------------------------------------------------+----------------+--------+
//| CLASS: ....... VosMain2                        | JAVA PROGRAM   | 001120 |
//+------------------------------------------------+----------------+--------+
//| PROGRAMMER: .. SIT Group                                                 |
//+--------------------------------------------------------------------------+
//| Description                                                              |
//| ===========                                                              |
//| The class that handles the VOS_MAIN2 table.                              |
//|                                                                          |
//+--------------------------------------------------------------------------+
//| History                                                                  |
//| =======                                                                  |
...
/**
 * This class manages the VOS_MAIN2 table with the help of the DbAccessC
 * class.   It has <b>get, put, del</b> and <b>upd</b> methods to <b>select,
 * insert, delete</b> and <b>update</b> the table.
 */
public class VosMain2 extends VosTable {
    ...
    /** The table name */
    //public static final String TABLE = "VOS_MAIN2";
    ...
    public VosMain2() {
        ...
        TABLE = "VOS_MAIN2";
        //clearVars();
        if (dbg) System.out.println ("<br>in VosMain2 constructor 1"); // debug
    } // VosMain2 constructor

    /**
     * Instantiate a VosMain2 object and initialize the instance variables.
    ...
    public VosMain2(
        ...
        if (dbg) System.out.println ("<br>in VosMain2 constructor 2"); // debug
    } // VosMain2 constructor
    ...
    public VosMain2(
        ...
        TABLE = "VOS_MAIN2";
        if (dbg) System.out.println ("<br>in VosMain2 constructor 3"); // debug
    } // VosMain2 constructor
     ...
     * are returned in an array of VosMain2. e.g.<pre>
     * VosMain2 vosMain2 = new VosMain2(<val1>);
     * VosMain2 vosMain2Array[] = vosMain2.get();</pre>
     * will get the VosMain2 record where latitude = <val1>.
     * @return Array of VosMain2 (VosMain2[])
     */
    public VosMain2[] get() {
     ...
     * e.g.<pre>
     * VosMain2 vosMain2Array[] =
     *     new VosMain2().get(VosMain2.LATITUDE+"=<val1>");</pre>
     * will get the VosMain2 record where latitude = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of VosMain2 (VosMain2[])
     */
    public VosMain2[] get (String where) {
     ...
     * VosMain2 vosMain2Array[] =
     *     new VosMain2().get("1=1",vosMain2.LATITUDE);</pre>
     * will get the all the VosMain2 records, and order them by latitude.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of VosMain2 (VosMain2[])
     */
    public VosMain2[] get (String where, String order) {
     ...
     * String columns = VosMain2.LATITUDE,VosMain2.LONGITUDE;
     * String where = VosMain2.LATITUDE + "=<val1";
     * String order = VosMain2.LATITUDE;
     * VosMain2 vosMain2Array[] =
     *     new VosMain2().get(columns, where, order);</pre>
     * will get the latitude and longitude colums of all VosMain2 records,
     ...
     * @return Array of VosMain2 (VosMain2[])
     */
    public VosMain2[] get (String fields, String where, String order) {
     ...
     *  .e.g.<pre>
     * Boolean success
     * VosMain2 vosMain2 = new VosMain2();
     * success = vosMain2.del(VosMain2.LATITUDE+"=<val1>");</pre>
     ...
     * update are taken from the VosMain2 argument, .e.g.<pre>
     * Boolean success
     * VosMain2 updVosMain2 = new VosMain2();
     * updVosMain2.setLongitude(<val2>);
     * VosMain2 whereVosMain2 = new VosMain2(<val1>);
     * success = whereVosMain2.upd(updJobs);</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  vosMain2  A VosMain2 variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(VosMain2 vosMain2) {
        return doUpd(TABLE, vosMain2, createWhere());
    } // method upd
     ...
     * VosMain2 updVosMain2 = new VosMain2();
     * updVosMain2.setLongitude(<val2>);
     * VosMain2 whereVosMain2 = new VosMain2();
     * success = whereVosMain2.upd(
     *     updVosMain2, VosMain2.LATITUDE+"=<val1>");</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  vosMain2  A VosMain2 variable in which the fields are to be used for
     *                 the update are set
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(VosMain2 vosMain2, String where) {
        return doUpd(TABLE, vosMain2, where);
    } // method upd
    ...
    /**
     * converts the VosTables array to a VosMain2 array
     */
    VosMain2[] cvt2Local (VosTable[] ct) {
        VosMain2[] local = new VosMain2[ct.length];
        for (int i = 0; i < ct.length; i++) {
            local[i] = new VosMain2();
