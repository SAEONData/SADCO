...
/**
 * This class manages the ETOPO table with the help of the DbAccessC
 ...
 */
public class MrnEtopo extends Tables {
    ...
    /** The table name */
    public static final String TABLE = "ETOPO";
    ...
    public MrnEtopo() {
        clearVars();
        if (dbg) System.out.println ("<br>in MrnEtopo constructor 1"); // debug
    } // MrnEtopo constructor

    /**
     * Instantiate a MrnEtopo object and initialize the instance variables.
    ...
    public MrnEtopo(
        ...
        if (dbg) System.out.println ("<br>in MrnEtopo constructor 2"); // debug
    } // MrnEtopo constructor
    ...
    public MrnEtopo(
        ...
        setHeight    (height   );
        if (dbg) System.out.println ("<br>in MrnEtopo constructor 3"); // debug
    } // MrnEtopo constructor
     ...
     * are returned in an array of MrnEtopo. e.g.<pre>
     * MrnEtopo etopo = new MrnEtopo(<val1>);
     * MrnEtopo etopoArray[] = etopo.get();</pre>
     * will get the MrnEtopo record where latitude = <val1>.
     * @return Array of MrnEtopo (MrnEtopo[])
     */
    public MrnEtopo[] get() {
     ...
     * e.g.<pre>
     * MrnEtopo etopoArray[] =
     *     new MrnEtopo().get(MrnEtopo.LATITUDE+"=<val1>");</pre>
     * will get the MrnEtopo record where latitude = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of MrnEtopo (MrnEtopo[])
     */
    public MrnEtopo[] get (String where) {
     ...
     * MrnEtopo etopoArray[] =
     *     new MrnEtopo().get("1=1",etopo.LATITUDE);</pre>
     * will get the all the MrnEtopo records, and order them by latitude.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of MrnEtopo (MrnEtopo[])
     */
    public MrnEtopo[] get (String where, String order) {
     ...
     * String columns = MrnEtopo.LATITUDE,MrnEtopo.LONGITUDE;
     * String where = MrnEtopo.LATITUDE + "=<val1";
     * String order = MrnEtopo.LATITUDE;
     * MrnEtopo etopoArray[] =
     *     new MrnEtopo().get(columns, where, order);</pre>
     * will get the latitude and longitude colums of all MrnEtopo records,
     ...
     * @return Array of MrnEtopo (MrnEtopo[])
     */
    public MrnEtopo[] get (String fields, String where, String order) {
     ...
     * and transforms it into an array of MrnEtopo.
     * @param  result  (Vector (rows) of Vectors (columns)).
     */
    private MrnEtopo[] doGet(Vector result) {
        ...
        MrnEtopo[] cArray = new MrnEtopo[result.size()];
        for (int i = 0; i < result.size(); i++) {
            Vector row = (Vector) result.elementAt(i);
            cArray[i] = new MrnEtopo();
            if (latitudeCol != -1)
     ...
     *  .e.g.<pre>
     * Boolean success
     * MrnEtopo etopo = new MrnEtopo();
     * success = etopo.del(MrnEtopo.LATITUDE+"=<val1>");</pre>
     ...
     * update are taken from the MrnEtopo argument, .e.g.<pre>
     * Boolean success
     * MrnEtopo updMrnEtopo = new MrnEtopo();
     * updMrnEtopo.setLongitude(<val2>);
     * MrnEtopo whereMrnEtopo = new MrnEtopo(<val1>);
     * success = whereMrnEtopo.upd(updMrnEtopo);</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  etopo  A MrnEtopo variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnEtopo etopo) {
        return db.update (TABLE, createColVals(etopo), createWhere());
    } // method upd
     ...
     * MrnEtopo updMrnEtopo = new MrnEtopo();
     * updMrnEtopo.setLongitude(<val2>);
     * MrnEtopo whereMrnEtopo = new MrnEtopo();
     * success = whereMrnEtopo.upd(
     *     updMrnEtopo, MrnEtopo.LATITUDE+"=<val1>");</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  etopo  A MrnEtopo variable in which the fields are to be used for
     *                 the update are set
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnEtopo etopo, String where) {
        return db.update (TABLE, createColVals(etopo), where);
    } // method upd
     ...
     */
    private String createColVals(MrnEtopo aVar) {
        String colVals = "";
