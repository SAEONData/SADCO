 ...
 */
public class ExtractCURFrame extends CompoundItem {
     ...
     */
    public ExtractCURFrame (String args[]) {

        try {
            ExtractCURFrameActual(args);
        } catch(Exception e) {
            ec.processError(e, this.getClass().getName(), "constructor", "");
        } // try - catch

    } // ExtractCURFrame constructor

    /**
    * Creates a page with a banner and an entry form
    * @param args the string array of url-type name-value parameter pairs
    */
    void ExtractCURFrameActual(String args[]) {
       ...
       String command =
            ...
            SadConstants.FLAGTYPE      + "=" + flagType      + " " +
            SadConstants.DATASET       + "=" + dataSet       + " " +
            SadConstants.PASSWORD      + "=" + password      + " " +
        ...
        //    //System.out.println("<br>before submit");
        //    ec.submitJob(command);
        //    //System.out.println("<br>after submit");
        //} // if ("morph".equals(ec.getHost()))
        ...
        // create the form
        Form form = new Form("POST", sc.CUR_APP);
    ...
    public static void main(String args[]) {
        try {
            ...
            // ExtractCURFrame local= new ExtractCURFrame(args);
