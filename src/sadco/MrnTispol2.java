...
/**
 * This class manages the TISPOL2 table with the help of the DbAccessC
 ...
 */
public class MrnTispol2 extends Tables {
    ...
    /** The table name */
    public static final String TABLE = "TISPOL2";
    ...
    public MrnTispol2() {
        clearVars();
        if (dbg) System.out.println ("<br>in MrnTispol2 constructor 1"); // debug
    } // MrnTispol2 constructor

    /**
     * Instantiate a MrnTispol2 object and initialize the instance variables.
    ...
    public MrnTispol2(
        ...
        this();
        setParseq     (parseq    );
        if (dbg) System.out.println ("<br>in MrnTispol2 constructor 2"); // debug
    } // MrnTispol2 constructor
    ...
    public MrnTispol2(
        ...
        if (dbg) System.out.println ("<br>in MrnTispol2 constructor 3"); // debug
    } // MrnTispol2 constructor
     ...
     * are returned in an array of MrnTispol2. e.g.<pre>
     * MrnTispol2 tispol2 = new MrnTispol2(<val1>);
     * MrnTispol2 tispol2Array[] = tispol2.get();</pre>
     * will get the MrnTispol2 record where parseq = <val1>.
     * @return Array of MrnTispol2 (MrnTispol2[])
     */
    public MrnTispol2[] get() {
     ...
     * e.g.<pre>
     * MrnTispol2 tispol2Array[] =
     *     new MrnTispol2().get(MrnTispol2.PARSEQ+"=<val1>");</pre>
     * will get the MrnTispol2 record where parseq = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of MrnTispol2 (MrnTispol2[])
     */
    public MrnTispol2[] get (String where) {
     ...
     * MrnTispol2 tispol2Array[] =
     *     new MrnTispol2().get("1=1",tispol2.PARSEQ);</pre>
     * will get the all the MrnTispol2 records, and order them by parseq.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of MrnTispol2 (MrnTispol2[])
     */
    public MrnTispol2[] get (String where, String order) {
     ...
     * String columns = MrnTispol2.PARSEQ,MrnTispol2.ALUMINIUM;
     * String where = MrnTispol2.PARSEQ + "=<val1";
     * String order = MrnTispol2.PARSEQ;
     * MrnTispol2 tispol2Array[] =
     *     new MrnTispol2().get(columns, where, order);</pre>
     * will get the parseq and aluminium colums of all MrnTispol2 records,
     ...
     * @return Array of MrnTispol2 (MrnTispol2[])
     */
    public MrnTispol2[] get (String fields, String where, String order) {
     ...
     * and transforms it into an array of MrnTispol2.
     * @param  result  (Vector (rows) of Vectors (columns)).
     */
    private MrnTispol2[] doGet(Vector result) {
        ...
        MrnTispol2[] cArray = new MrnTispol2[result.size()];
        for (int i = 0; i < result.size(); i++) {
            Vector row = (Vector) result.elementAt(i);
            cArray[i] = new MrnTispol2();
            if (parseqCol != -1)
     ...
     * Boolean success = new MrnTispol2(
     *     Tables.INTNULL,
     *     <val2>,
     *     Tables.FLOATNULL,
     *     Tables.FLOATNULL,
     ...
     *  .e.g.<pre>
     * Boolean success
     * MrnTispol2 tispol2 = new MrnTispol2();
     * success = tispol2.del(MrnTispol2.PARSEQ+"=<val1>");</pre>
     ...
     * update are taken from the MrnTispol2 argument, .e.g.<pre>
     * Boolean success
     * MrnTispol2 updMrnTispol2 = new MrnTispol2();
     * updMrnTispol2.setAluminium(<val2>);
     * MrnTispol2 whereMrnTispol2 = new MrnTispol2(<val1>);
     * success = whereMrnTispol2.upd(updMrnTispol2);</pre>
     * will update Aluminium to <val2> for all records where
     * parseq = <val1>.
     * @param  tispol2  A MrnTispol2 variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnTispol2 tispol2) {
        return db.update (TABLE, createColVals(tispol2), createWhere());
    } // method upd
     ...
     * MrnTispol2 updMrnTispol2 = new MrnTispol2();
     * updMrnTispol2.setAluminium(<val2>);
     * MrnTispol2 whereMrnTispol2 = new MrnTispol2();
     * success = whereMrnTispol2.upd(
     *     updMrnTispol2, MrnTispol2.PARSEQ+"=<val1>");</pre>
     * will update Aluminium to <val2> for all records where
     * parseq = <val1>.
     * @param  tispol2  A MrnTispol2 variable in which the fields are to be used for
     *                 the update are set
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnTispol2 tispol2, String where) {
        return db.update (TABLE, createColVals(tispol2), where);
    } // method upd
     ...
     */
    private String createColVals(MrnTispol2 aVar) {
        String colVals = "";
