...
/**
 * This class manages the EDM_CLIENT2 table with the help of the DbAccessC
 ...
 */
public class EdmClient2 extends Tables {
    ...
    /** The table name */
    public static final String TABLE = "EDM_CLIENT2";
    /** The code field name */
    ...
    public EdmClient2() {
        clearVars();
        if (dbg) System.out.println ("<br>in EdmClient2 constructor 1"); // debug
    } // EdmClient2 constructor

    /**
     * Instantiate a EdmClient2 object and initialize the instance variables.
    ...
    public EdmClient2(
        ...
        this();
        setCode (code);
        if (dbg) System.out.println ("<br>in EdmClient2 constructor 2"); // debug
    } // EdmClient2 constructor
    ...
    public EdmClient2(
        ...
        setCode (code);
        setName (name);
        if (dbg) System.out.println ("<br>in EdmClient2 constructor 3"); // debug
    } // EdmClient2 constructor
     ...
     * are returned in an array of EdmClient2. e.g.<pre>
     * EdmClient2 edmClient2 = new EdmClient2(<val1>);
     * EdmClient2 edmClient2Array[] = edmClient2.get();</pre>
     * will get the EdmClient2 record where code = <val1>.
     * @return Array of EdmClient2 (EdmClient2[])
     */
    public EdmClient2[] get() {
     ...
     * e.g.<pre>
     * EdmClient2 edmClient2Array[] = 
     *     new EdmClient2().get(EdmClient2.CODE+"=<val1>");</pre>
     * will get the EdmClient2 record where code = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of EdmClient2 (EdmClient2[])
     */
    public EdmClient2[] get (String where) {
     ...
     * EdmClient2 edmClient2Array[] = 
     *     new EdmClient2().get("1=1",edmClient2.CODE);</pre>
     * will get the all the EdmClient2 records, and order them by code.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of EdmClient2 (EdmClient2[])
     */
    public EdmClient2[] get (String where, String order) {
     ...
     * String columns = EdmClient2.CODE,EdmClient2.NAME;
     * String where = EdmClient2.CODE + "=<val1";
     * String order = EdmClient2.CODE;
     * EdmClient2 edmClient2Array[] = 
     *     new EdmClient2().get(columns, where, order);</pre>
     * will get the code and name colums of all EdmClient2 records,
     ...
     * @return Array of EdmClient2 (EdmClient2[])
     */
    public EdmClient2[] get (String fields, String where, String order) {
     ...
     * and transforms it into an array of EdmClient2.
     * @param  result  (Vector (rows) of Vectors (columns)).
     */
    private EdmClient2[] doGet(Vector result) {
        if (dbg) System.out.println ("vector size = " + result.size());
        int codeCol = db.getColNumber(CODE);
        int nameCol = db.getColNumber(NAME);
        EdmClient2[] cArray = new EdmClient2[result.size()];
        for (int i = 0; i < result.size(); i++) {
            Vector row = (Vector) result.elementAt(i);
            cArray[i] = new EdmClient2();
            if (codeCol != -1)
     ...
     * Boolean success = new EdmClient2(
     *     Tables.INTNULL,
     *     <val2>,
     ...
     *  .e.g.<pre>
     * Boolean success
     * EdmClient2 edmClient2 = new EdmClient2();
     * success = edmClient2.del(EdmClient2.CODE+"=<val1>");</pre>
     ...
     * update are taken from the EdmClient2 argument, .e.g.<pre>
     * Boolean success
     * EdmClient2 updEdmClient2 = new EdmClient2();
     * updEdmClient2.setName(<val2>);
     * EdmClient2 whereEdmClient2 = new EdmClient2(<val1>);
     * success = whereEdmClient2.upd(updEdmClient2);</pre>
     * will update Name to <val2> for all records where 
     * code = <val1>.
     * @param edmClient2  A EdmClient2 variable in which the fields are to be used for 
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(EdmClient2 edmClient2) {
        return db.update (TABLE, createColVals(edmClient2), createWhere());
    } // method upd
     ...
     * EdmClient2 updEdmClient2 = new EdmClient2();
     * updEdmClient2.setName(<val2>);
     * EdmClient2 whereEdmClient2 = new EdmClient2();
     * success = whereEdmClient2.upd(
     *     updEdmClient2, EdmClient2.CODE+"=<val1>");</pre>
     * will update Name to <val2> for all records where 
     * code = <val1>.
     * @param  updEdmClient2  A EdmClient2 variable in which the fields are to be used for 
     *                 the update are set
     * @param  where  The where clause for the select statement. (String)
     * @return success = true/false (boolean)
     */
    public boolean upd(EdmClient2 edmClient2, String where) {
        return db.update (TABLE, createColVals(edmClient2), where);
    } // method upd
     ...
     */
    private String createColVals(EdmClient2 aVar) {
        String colVals = "";
