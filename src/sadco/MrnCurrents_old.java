...
/**
 * This class manages the WATCURRENTS2 table with the help of the DbAccessC
 * class.   It has <b>get, put, del</b> and <b>upd</b> methods to <b>select,
 *insert, delete</b> and <b>update</b> the table.
 *
 * @author 040609 - SIT Group
 * @version
 * 040609 - GenTableClassB class - create class<br>
 */
public class MrnCurrents extends Tables {
     ...
     * MrnCurrents watcurrents2 = new MrnCurrents(<val1>);
     * MrnCurrents watcurrents2Array[] = watcurrents2.get();</pre>
     ...
     * MrnCurrents watcurrents2Array[] =
     *     new MrnCurrents().get("1=1",watcurrents2.STATION_ID);</pre>
    ...
    public MrnCurrents[] get (String fields, String where, String order) {
        ...
        //System.out.println("<br>select " + fields + " from " + TABLE + " where " + where +  " order by " + order);
     ...
     *  .e.g.<pre>
     * Boolean success
     * MrnCurrents watcurrents2 = new MrnCurrents();
     * success = watcurrents2.del(MrnCurrents.STATION_ID+"=<val1>");</pre>
     ...
     * stationId = <val1>.
     * @param  watcurrents2  A MrnCurrents variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnCurrents watcurrents2) {
        return db.update (TABLE, createColVals(watcurrents2), createWhere());
    } // method upd
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnCurrents watcurrents2, String where) {
        return db.update (TABLE, createColVals(watcurrents2), where);
    } // method upd
