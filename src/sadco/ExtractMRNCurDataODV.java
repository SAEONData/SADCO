 ...
 */
public class ExtractMRNCurDataODV {
    ...
    /**
     * Main constructor ExtractMRNCurDataODV
     * @param   args   String array of arguments as from form or URL
     */
    public ExtractMRNCurDataODV(String args[])  {
...
//        printHeader();
    ...
    } // ExtractMRNCurDataODV(String args[])
...
*/
        ...
        ec.frm(station.getStationId(),12)           +tab+       //ub04
        ec.frm(sub,5)                               +tab+
        month+"/" +day+"/"+ year                    +tab+
        ftime.trim()                                +tab+
        ...
        nullToNULL(currents.getCurrentDir(),8,0)    +tab+
        nullToNULL(currents.getCurrentSpeed(),8,3)  +tab+
...
*/
    ...
    LogUsers createLogUsers(String userid, Timestamp start, String timeDiff) {//ub04
        ...
        logs.setDiscipline("curodv");                                   //ub04
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ExtractMRNCurDataODV local =
                new ExtractMRNCurDataODV(args);
        } catch(Exception e) {
            common.edmCommonPC.processErrorStatic(
                e, "ExtractMRNCurDataODV", "Constructor", "");
        } // try-catch
