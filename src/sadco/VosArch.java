//+------------------------------------------------+----------------+--------+
//| CLASS: ....... VosArch                         | JAVA PROGRAM   | 001120 |
//+------------------------------------------------+----------------+--------+
//| PROGRAMMER: .. SIT Group                                                 |
//+--------------------------------------------------------------------------+
//| Description                                                              |
//| ===========                                                              |
//| The class that handles the VOS_ARCH table.                               |
//|                                                                          |
//+--------------------------------------------------------------------------+
//| History                                                                  |
//| =======                                                                  |
...
/**
 * This class manages the VOS_ARCH table with the help of the DbAccessC
 * class.   It has <b>get, put, del</b> and <b>upd</b> methods to <b>select,
 * insert, delete</b> and <b>update</b> the table.
 */
public class VosArch extends VosTable {
    ...
    /** The table name */
    //public static final String TABLE = "VOS_ARCH";
    ...
    public VosArch() {
        ...
        TABLE = "VOS_ARCH";
        //clearVars();
        if (dbg) System.out.println ("<br>in VosArch constructor 1"); // debug
    } // VosArch constructor

    /**
     * Instantiate a VosArch object and initialize the instance variables.
    ...
    public VosArch(
        ...
        if (dbg) System.out.println ("<br>in VosArch constructor 2"); // debug
    } // VosArch constructor
    ...
    public VosArch(
        ...
        TABLE = "VOS_ARCH";
        if (dbg) System.out.println ("<br>in VosArch constructor 3"); // debug
    } // VosArch constructor
     ...
     * are returned in an array of VosArch. e.g.<pre>
     * VosArch vosArch = new VosArch(<val1>);
     * VosArch vosArchArray[] = vosArch.get();</pre>
     * will get the VosArch record where latitude = <val1>.
     * @return Array of VosArch (VosArch[])
     */
    public VosArch[] get() {
     ...
     * e.g.<pre>
     * VosArch vosArchArray[] =
     *     new VosArch().get(VosArch.LATITUDE+"=<val1>");</pre>
     * will get the VosArch record where latitude = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of VosArch (VosArch[])
     */
    public VosArch[] get (String where) {
     ...
     * VosArch vosArchArray[] =
     *     new VosArch().get("1=1",vosArch.LATITUDE);</pre>
     * will get the all the VosArch records, and order them by latitude.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of VosArch (VosArch[])
     */
    public VosArch[] get (String where, String order) {
     ...
     * String columns = VosArch.LATITUDE,VosArch.LONGITUDE;
     * String where = VosArch.LATITUDE + "=<val1";
     * String order = VosArch.LATITUDE;
     * VosArch vosArchArray[] =
     *     new VosArch().get(columns, where, order);</pre>
     * will get the latitude and longitude colums of all VosArch records,
     ...
     * @return Array of VosArch (VosArch[])
     */
    public VosArch[] get (String fields, String where, String order) {
     ...
     *  .e.g.<pre>
     * Boolean success
     * VosArch vosArch = new VosArch();
     * success = vosArch.del(VosArch.LATITUDE+"=<val1>");</pre>
     ...
     * update are taken from the VosArch argument, .e.g.<pre>
     * Boolean success
     * VosArch updVosArch = new VosArch();
     * updVosArch.setLongitude(<val2>);
     * VosArch whereVosArch = new VosArch(<val1>);
     * success = whereVosArch.upd(updJobs);</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  vosArch  A VosArch variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(VosArch vosArch) {
        return doUpd(TABLE, vosArch, createWhere());
    } // method upd
     ...
     * VosArch updVosArch = new VosArch();
     * updVosArch.setLongitude(<val2>);
     * VosArch whereVosArch = new VosArch();
     * success = whereVosArch.upd(
     *     updVosArch, VosArch.LATITUDE+"=<val1>");</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  vosArch  A VosArch variable in which the fields are to be used for
     *                 the update are set
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(VosArch vosArch, String where) {
        return doUpd(TABLE, vosArch, where);
    } // method upd
    ...
    /**
     * converts the VosTables array to a VosArch array
     */
    VosArch[] cvt2Local (VosTable[] ct) {
        VosArch[] local = new VosArch[ct.length];
