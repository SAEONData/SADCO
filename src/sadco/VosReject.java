//+------------------------------------------------+----------------+--------+
//| CLASS: ....... VosReject                       | JAVA PROGRAM   | 001120 |
//+------------------------------------------------+----------------+--------+
//| PROGRAMMER: .. SIT Group                                                 |
//+--------------------------------------------------------------------------+
//| Description                                                              |
//| ===========                                                              |
//| The class that handles the VOS_REJECT table.                             |
//|                                                                          |
//+--------------------------------------------------------------------------+
//| History                                                                  |
//| =======                                                                  |
...
/**
 * This class manages the VOS_REJECT table with the help of the DbAccessC
 * class.   It has <b>get, put, del</b> and <b>upd</b> methods to <b>select,
 * insert, delete</b> and <b>update</b> the table.
 */
public class VosReject extends VosTable {
    ...
    /** The table name */
    //public static final String TABLE = "VOS_REJECT";
    ...
    public VosReject() {
        ...
        TABLE = "VOS_REJECT";
        //clearVars();
        if (dbg) System.out.println ("<br>in VosReject constructor 1"); // debug
    } // VosReject constructor

    /**
     * Instantiate a VosReject object and initialize the instance variables.
    ...
    public VosReject(
        ...
        if (dbg) System.out.println ("<br>in VosReject constructor 2"); // debug
    } // VosReject constructor
    ...
    public VosReject(
        ...
        TABLE = "VOS_REJECT";
        if (dbg) System.out.println ("<br>in VosReject constructor 3"); // debug
    } // VosReject constructor
     ...
     * are returned in an array of VosReject. e.g.<pre>
     * VosReject VosReject = new VosReject(<val1>);
     * VosReject VosRejectArray[] = VosReject.get();</pre>
     * will get the VosReject record where latitude = <val1>.
     * @return Array of VosReject (VosReject[])
     */
    public VosReject[] get() {
     ...
     * e.g.<pre>
     * VosReject VosRejectArray[] =
     *     new VosReject().get(VosReject.LATITUDE+"=<val1>");</pre>
     * will get the VosReject record where latitude = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of VosReject (VosReject[])
     */
    public VosReject[] get (String where) {
     ...
     * VosReject VosRejectArray[] =
     *     new VosReject().get("1=1",VosReject.LATITUDE);</pre>
     * will get the all the VosReject records, and order them by latitude.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of VosReject (VosReject[])
     */
    public VosReject[] get (String where, String order) {
     ...
     * String columns = VosReject.LATITUDE,VosReject.LONGITUDE;
     * String where = VosReject.LATITUDE + "=<val1";
     * String order = VosReject.LATITUDE;
     * VosReject VosRejectArray[] =
     *     new VosReject().get(columns, where, order);</pre>
     * will get the latitude and longitude colums of all VosReject records,
     ...
     * @return Array of VosReject (VosReject[])
     */
    public VosReject[] get (String fields, String where, String order) {
     ...
     *  .e.g.<pre>
     * Boolean success
     * VosReject VosReject = new VosReject();
     * success = VosReject.del(VosReject.LATITUDE+"=<val1>");</pre>
     ...
     * update are taken from the VosReject argument, .e.g.<pre>
     * Boolean success
     * VosReject updVosReject = new VosReject();
     * updVosReject.setLongitude(<val2>);
     * VosReject whereVosReject = new VosReject(<val1>);
     * success = whereVosReject.upd(updJobs);</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  vosReject  A VosReject variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(VosReject vosReject) {
        return doUpd(TABLE, vosReject, createWhere());
    } // method upd
     ...
     * VosReject updVosReject = new VosReject();
     * updVosReject.setLongitude(<val2>);
     * VosReject whereVosReject = new VosReject();
     * success = whereVosReject.upd(
     *     updVosReject, VosReject.LATITUDE+"=<val1>");</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  vosReject  A VosReject variable in which the fields are to be used for
     *                 the update are set
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(VosReject vosReject, String where) {
        return doUpd(TABLE, vosReject, where);
    } // method upd
    ...
    /**
     * converts the VosTables array to a VosReject array
     */
    VosReject[] cvt2Local (VosTable[] ct) {
        VosReject[] local = new VosReject[ct.length];
        for (int i = 0; i < ct.length; i++) {
            local[i] = new VosReject();
