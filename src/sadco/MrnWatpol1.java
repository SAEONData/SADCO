...
/**
 * This class manages the WATPOL1 table with the help of the DbAccessC
 ...
 */
public class MrnWatpol1 extends Tables {
    ...
    /** The table name */
    public static final String TABLE = "WATPOL1";
    ...
    public MrnWatpol1() {
        clearVars();
        if (dbg) System.out.println ("<br>in MrnWatpol1 constructor 1"); // debug
    } // MrnWatpol1 constructor

    /**
     * Instantiate a MrnWatpol1 object and initialize the instance variables.
    ...
    public MrnWatpol1(
        ...
        if (dbg) System.out.println ("<br>in MrnWatpol1 constructor 2"); // debug
    } // MrnWatpol1 constructor
    ...
    public MrnWatpol1(
        ...
        setZinc       (zinc      );
        if (dbg) System.out.println ("<br>in MrnWatpol1 constructor 3"); // debug
    } // MrnWatpol1 constructor
     ...
     * are returned in an array of MrnWatpol1. e.g.<pre>
     * MrnWatpol1 watpol1 = new MrnWatpol1(<val1>);
     * MrnWatpol1 watpol1Array[] = watpol1.get();</pre>
     * will get the MrnWatpol1 record where watphyCode = <val1>.
     * @return Array of MrnWatpol1 (MrnWatpol1[])
     */
    public MrnWatpol1[] get() {
     ...
     * e.g.<pre>
     * MrnWatpol1 watpol1Array[] =
     *     new MrnWatpol1().get(MrnWatpol1.WATPHY_CODE+"=<val1>");</pre>
     * will get the MrnWatpol1 record where watphyCode = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of MrnWatpol1 (MrnWatpol1[])
     */
    public MrnWatpol1[] get (String where) {
     ...
     * MrnWatpol1 watpol1Array[] =
     *     new MrnWatpol1().get("1=1",watpol1.WATPHY_CODE);</pre>
     * will get the all the MrnWatpol1 records, and order them by watphyCode.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of MrnWatpol1 (MrnWatpol1[])
     */
    public MrnWatpol1[] get (String where, String order) {
     ...
     * String columns = MrnWatpol1.WATPHY_CODE,MrnWatpol1.ARSENIC;
     * String where = MrnWatpol1.WATPHY_CODE + "=<val1";
     * String order = MrnWatpol1.WATPHY_CODE;
     * MrnWatpol1 watpol1Array[] =
     *     new MrnWatpol1().get(columns, where, order);</pre>
     * will get the watphyCode and arsenic colums of all MrnWatpol1 records,
     ...
     * @return Array of MrnWatpol1 (MrnWatpol1[])
     */
    public MrnWatpol1[] get (String fields, String where, String order) {
     ...
     * and transforms it into an array of MrnWatpol1.
     * @param  result  (Vector (rows) of Vectors (columns)).
     */
    private MrnWatpol1[] doGet(Vector result) {
        ...
        MrnWatpol1[] cArray = new MrnWatpol1[result.size()];
        for (int i = 0; i < result.size(); i++) {
            Vector row = (Vector) result.elementAt(i);
            cArray[i] = new MrnWatpol1();
            if (watphyCodeCol != -1)
     ...
     * Boolean success = new MrnWatpol1(
     *     Tables.INTNULL,
     *     <val2>,
     *     Tables.FLOATNULL,
     *     Tables.FLOATNULL,
     ...
     * success = watpol1.del(MrnWatpol1.WATPHY_CODE+"=<val1>");</pre>
     ...
     * update are taken from the MrnWatpol1 argument, .e.g.<pre>
     * Boolean success
     * MrnWatpol1 updMrnWatpol1 = new MrnWatpol1();
     * updMrnWatpol1.setArsenic(<val2>);
     * MrnWatpol1 whereMrnWatpol1 = new MrnWatpol1(<val1>);
     * success = whereMrnWatpol1.upd(updMrnWatpol1);</pre>
     * will update Arsenic to <val2> for all records where
     * watphyCode = <val1>.
     * @param  watpol1  A MrnWatpol1 variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnWatpol1 watpol1) {
        return db.update (TABLE, createColVals(watpol1), createWhere());
    } // method upd
     ...
     * MrnWatpol1 updMrnWatpol1 = new MrnWatpol1();
     * updMrnWatpol1.setArsenic(<val2>);
     * MrnWatpol1 whereMrnWatpol1 = new MrnWatpol1();
     * success = whereMrnWatpol1.upd(
     *     updMrnWatpol1, MrnWatpol1.WATPHY_CODE+"=<val1>");</pre>
     * will update Arsenic to <val2> for all records where
     * watphyCode = <val1>.
     * @param  watpol1  A MrnWatpol1 variable in which the fields are to be used for
     *                 the update are set
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnWatpol1 watpol1, String where) {
        return db.update (TABLE, createColVals(watpol1), where);
    } // method upd
     ...
     */
    private String createColVals(MrnWatpol1 aVar) {
        String colVals = "";
