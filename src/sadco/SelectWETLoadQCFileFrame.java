 ...
 * 110810 - Ursula von St Ange  - copy from sadco.SelectCURLoadQCFileFrame  <br>
 */
public class SelectWETLoadQCFileFrame extends CompoundItem {
    ...
    public SelectWETLoadQCFileFrame(String args[]) {
        ...
        if (dbg) System.out.println(
            "sadco.SelectWETLoadQCFileFrame: pathName = " + pathName);
        ...
        if (dbg) System.out.println (
            "sadco.SelectWETLoadQCFileFrame: fileList.length = " + fileList.length);
        ...
        if (files.size() > 0) {
            // create form
            Form form = new Form("get", cc.WET_APP);
...
//    } // createTimeZoneSelect
      ...
      public static void main(String args[]) {
          ...
          try {
              HtmlHead hd = new HtmlHead("SelectWETLoadQCFileFrame local");
              ...
              //ec.processErrorStatic(e, "SelectWETLoadQCFileFrame", "Constructor", "");
