...
/**
 * This class manages the TISPOL1 table with the help of the DbAccessC
 ...
 */
public class MrnTispol1 extends Tables {
    ...
    /** The table name */
    public static final String TABLE = "TISPOL1";
    ...
    public MrnTispol1() {
        clearVars();
        if (dbg) System.out.println ("<br>in MrnTispol1 constructor 1"); // debug
    } // MrnTispol1 constructor

    /**
     * Instantiate a MrnTispol1 object and initialize the instance variables.
    ...
    public MrnTispol1(
        ...
        this();
        setParseq    (parseq   );
        if (dbg) System.out.println ("<br>in MrnTispol1 constructor 2"); // debug
    } // MrnTispol1 constructor
    ...
    public MrnTispol1(
        ...
        setZinc      (zinc     );
        if (dbg) System.out.println ("<br>in MrnTispol1 constructor 3"); // debug
    } // MrnTispol1 constructor
     ...
     * are returned in an array of MrnTispol1. e.g.<pre>
     * MrnTispol1 tispol1 = new MrnTispol1(<val1>);
     * MrnTispol1 tispol1Array[] = tispol1.get();</pre>
     * will get the MrnTispol1 record where parseq = <val1>.
     * @return Array of MrnTispol1 (MrnTispol1[])
     */
    public MrnTispol1[] get() {
     ...
     * e.g.<pre>
     * MrnTispol1 tispol1Array[] =
     *     new MrnTispol1().get(MrnTispol1.PARSEQ+"=<val1>");</pre>
     * will get the MrnTispol1 record where parseq = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of MrnTispol1 (MrnTispol1[])
     */
    public MrnTispol1[] get (String where) {
     ...
     * MrnTispol1 tispol1Array[] =
     *     new MrnTispol1().get("1=1",tispol1.PARSEQ);</pre>
     * will get the all the MrnTispol1 records, and order them by parseq.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of MrnTispol1 (MrnTispol1[])
     */
    public MrnTispol1[] get (String where, String order) {
     ...
     * String columns = MrnTispol1.PARSEQ,MrnTispol1.ARSENIC;
     * String where = MrnTispol1.PARSEQ + "=<val1";
     * String order = MrnTispol1.PARSEQ;
     * MrnTispol1 tispol1Array[] =
     *     new MrnTispol1().get(columns, where, order);</pre>
     * will get the parseq and arsenic colums of all MrnTispol1 records,
     ...
     * @return Array of MrnTispol1 (MrnTispol1[])
     */
    public MrnTispol1[] get (String fields, String where, String order) {
     ...
     * and transforms it into an array of MrnTispol1.
     * @param  result  (Vector (rows) of Vectors (columns)).
     */
    private MrnTispol1[] doGet(Vector result) {
        ...
        MrnTispol1[] cArray = new MrnTispol1[result.size()];
        for (int i = 0; i < result.size(); i++) {
            Vector row = (Vector) result.elementAt(i);
            cArray[i] = new MrnTispol1();
            if (parseqCol != -1)
     ...
     * Boolean success = new MrnTispol1(
     *     Tables.INTNULL,
     *     <val2>,
     *     Tables.FLOATNULL,
     *     Tables.FLOATNULL,
     ...
     *  .e.g.<pre>
     * Boolean success
     * MrnTispol1 tispol1 = new MrnTispol1();
     * success = tispol1.del(MrnTispol1.PARSEQ+"=<val1>");</pre>
     ...
     * update are taken from the MrnTispol1 argument, .e.g.<pre>
     * Boolean success
     * MrnTispol1 updMrnTispol1 = new MrnTispol1();
     * updMrnTispol1.setArsenic(<val2>);
     * MrnTispol1 whereMrnTispol1 = new MrnTispol1(<val1>);
     * success = whereMrnTispol1.upd(updMrnTispol1);</pre>
     * will update Arsenic to <val2> for all records where
     * parseq = <val1>.
     * @param  tispol1  A MrnTispol1 variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnTispol1 tispol1) {
        return db.update (TABLE, createColVals(tispol1), createWhere());
    } // method upd
     ...
     * MrnTispol1 updMrnTispol1 = new MrnTispol1();
     * updMrnTispol1.setArsenic(<val2>);
     * MrnTispol1 whereMrnTispol1 = new MrnTispol1();
     * success = whereMrnTispol1.upd(
     *     updMrnTispol1, MrnTispol1.PARSEQ+"=<val1>");</pre>
     * will update Arsenic to <val2> for all records where
     * parseq = <val1>.
     * @param  tispol1  A MrnTispol1 variable in which the fields are to be used for
     *                 the update are set
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnTispol1 tispol1, String where) {
        return db.update (TABLE, createColVals(tispol1), where);
    } // method upd
     ...
     */
    private String createColVals(MrnTispol1 aVar) {
        String colVals = "";
