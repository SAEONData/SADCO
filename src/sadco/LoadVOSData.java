 ...
 * 040909 - Mario August - LoadVOSData not being used any more.
 *                         LoadVOSData2 is use instead.
 */
public class LoadVOSData { // extends CompoundItem {
    ...
    public LoadVOSData(String args[]) {
        ...
        String dummyFile2 = pathName + fileName + ".processing";
