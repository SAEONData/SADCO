...
/**
 * This class manages the PLAPOL2 table with the help of the DbAccessC
 ...
 */
public class MrnPlapol2 extends Tables {
    ...
    /** The table name */
    public static final String TABLE = "PLAPOL2";
    ...
    public MrnPlapol2() {
        clearVars();
        if (dbg) System.out.println ("<br>in MrnPlapol2 constructor 1"); // debug
    } // MrnPlapol2 constructor

    /**
     * Instantiate a MrnPlapol2 object and initialize the instance variables.
    ...
    public MrnPlapol2(
        ...
        if (dbg) System.out.println ("<br>in MrnPlapol2 constructor 2"); // debug
    } // MrnPlapol2 constructor
    ...
    public MrnPlapol2(
        ...
        if (dbg) System.out.println ("<br>in MrnPlapol2 constructor 3"); // debug
    } // MrnPlapol2 constructor
     ...
     * are returned in an array of MrnPlapol2. e.g.<pre>
     * MrnPlapol2 plapol2 = new MrnPlapol2(<val1>);
     * MrnPlapol2 plapol2Array[] = plapol2.get();</pre>
     * will get the MrnPlapol2 record where plaphyCode = <val1>.
     * @return Array of MrnPlapol2 (MrnPlapol2[])
     */
    public MrnPlapol2[] get() {
     ...
     * e.g.<pre>
     * MrnPlapol2 plapol2Array[] = 
     *     new MrnPlapol2().get(MrnPlapol2.PLAPHY_CODE+"=<val1>");</pre>
     * will get the MrnPlapol2 record where plaphyCode = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of MrnPlapol2 (MrnPlapol2[])
     */
    public MrnPlapol2[] get (String where) {
     ...
     * MrnPlapol2 plapol2Array[] = 
     *     new MrnPlapol2().get("1=1",plapol2.PLAPHY_CODE);</pre>
     * will get the all the MrnPlapol2 records, and order them by plaphyCode.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of MrnPlapol2 (MrnPlapol2[])
     */
    public MrnPlapol2[] get (String where, String order) {
     ...
     * String columns = MrnPlapol2.PLAPHY_CODE,MrnPlapol2.ALUMINIUM;
     * String where = MrnPlapol2.PLAPHY_CODE + "=<val1";
     * String order = MrnPlapol2.PLAPHY_CODE;
     * MrnPlapol2 plapol2Array[] = 
     *     new MrnPlapol2().get(columns, where, order);</pre>
     * will get the plaphyCode and aluminium colums of all MrnPlapol2 records,
     ...
     * @return Array of MrnPlapol2 (MrnPlapol2[])
     */
    public MrnPlapol2[] get (String fields, String where, String order) {
     ...
     * and transforms it into an array of MrnPlapol2.
     * @param  result  (Vector (rows) of Vectors (columns)).
     */
    private MrnPlapol2[] doGet(Vector result) {
        ...
        MrnPlapol2[] cArray = new MrnPlapol2[result.size()];
        for (int i = 0; i < result.size(); i++) {
            Vector row = (Vector) result.elementAt(i);
            cArray[i] = new MrnPlapol2();
            if (plaphyCodeCol != -1)
     ...
     * Boolean success = new MrnPlapol2(
     *     Tables.INTNULL,
     *     <val2>,
     *     Tables.FLOATNULL,
     *     Tables.FLOATNULL,
     ...
     *  .e.g.<pre>
     * Boolean success
     * MrnPlapol2 plapol2 = new MrnPlapol2();
     * success = plapol2.del(MrnPlapol2.PLAPHY_CODE+"=<val1>");</pre>
     ...
     * update are taken from the MrnPlapol2 argument, .e.g.<pre>
     * Boolean success
     * MrnPlapol2 updMrnPlapol2 = new MrnPlapol2();
     * updMrnPlapol2.setAluminium(<val2>);
     * MrnPlapol2 whereMrnPlapol2 = new MrnPlapol2(<val1>);
     * success = whereMrnPlapol2.upd(updMrnPlapol2);</pre>
     * will update Aluminium to <val2> for all records where 
     * plaphyCode = <val1>.
     * @param plapol2  A MrnPlapol2 variable in which the fields are to be used for 
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnPlapol2 plapol2) {
        return db.update (TABLE, createColVals(plapol2), createWhere());
    } // method upd
     ...
     * MrnPlapol2 updMrnPlapol2 = new MrnPlapol2();
     * updMrnPlapol2.setAluminium(<val2>);
     * MrnPlapol2 whereMrnPlapol2 = new MrnPlapol2();
     * success = whereMrnPlapol2.upd(
     *     updMrnPlapol2, MrnPlapol2.PLAPHY_CODE+"=<val1>");</pre>
     * will update Aluminium to <val2> for all records where 
     * plaphyCode = <val1>.
     * @param  updMrnPlapol2  A MrnPlapol2 variable in which the fields are to be used for 
     *                 the update are set
     * @param  where  The where clause for the select statement. (String)
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnPlapol2 plapol2, String where) {
        return db.update (TABLE, createColVals(plapol2), where);
    } // method upd
     ...
     */
    private String createColVals(MrnPlapol2 aVar) {
        String colVals = "";
