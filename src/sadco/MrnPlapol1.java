...
/**
 * This class manages the PLAPOL1 table with the help of the DbAccessC
 ...
 */
public class MrnPlapol1 extends Tables {
    ...
    /** The table name */
    public static final String TABLE = "PLAPOL1";
    ...
    public MrnPlapol1() {
        clearVars();
        if (dbg) System.out.println ("<br>in MrnPlapol1 constructor 1"); // debug
    } // MrnPlapol1 constructor

    /**
     * Instantiate a MrnPlapol1 object and initialize the instance variables.
    ...
    public MrnPlapol1(
        ...
        if (dbg) System.out.println ("<br>in MrnPlapol1 constructor 2"); // debug
    } // MrnPlapol1 constructor
    ...
    public MrnPlapol1(
        ...
        setZinc       (zinc      );
        if (dbg) System.out.println ("<br>in MrnPlapol1 constructor 3"); // debug
    } // MrnPlapol1 constructor
     ...
     * are returned in an array of MrnPlapol1. e.g.<pre>
     * MrnPlapol1 plapol1 = new MrnPlapol1(<val1>);
     * MrnPlapol1 plapol1Array[] = plapol1.get();</pre>
     * will get the MrnPlapol1 record where plaphyCode = <val1>.
     * @return Array of MrnPlapol1 (MrnPlapol1[])
     */
    public MrnPlapol1[] get() {
     ...
     * e.g.<pre>
     * MrnPlapol1 plapol1Array[] = 
     *     new MrnPlapol1().get(MrnPlapol1.PLAPHY_CODE+"=<val1>");</pre>
     * will get the MrnPlapol1 record where plaphyCode = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of MrnPlapol1 (MrnPlapol1[])
     */
    public MrnPlapol1[] get (String where) {
     ...
     * MrnPlapol1 plapol1Array[] = 
     *     new MrnPlapol1().get("1=1",plapol1.PLAPHY_CODE);</pre>
     * will get the all the MrnPlapol1 records, and order them by plaphyCode.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of MrnPlapol1 (MrnPlapol1[])
     */
    public MrnPlapol1[] get (String where, String order) {
     ...
     * String columns = MrnPlapol1.PLAPHY_CODE,MrnPlapol1.ARSENIC;
     * String where = MrnPlapol1.PLAPHY_CODE + "=<val1";
     * String order = MrnPlapol1.PLAPHY_CODE;
     * MrnPlapol1 plapol1Array[] = 
     *     new MrnPlapol1().get(columns, where, order);</pre>
     * will get the plaphyCode and arsenic colums of all MrnPlapol1 records,
     ...
     * @return Array of MrnPlapol1 (MrnPlapol1[])
     */
    public MrnPlapol1[] get (String fields, String where, String order) {
     ...
     * and transforms it into an array of MrnPlapol1.
     * @param  result  (Vector (rows) of Vectors (columns)).
     */
    private MrnPlapol1[] doGet(Vector result) {
        ...
        MrnPlapol1[] cArray = new MrnPlapol1[result.size()];
        for (int i = 0; i < result.size(); i++) {
            Vector row = (Vector) result.elementAt(i);
            cArray[i] = new MrnPlapol1();
            if (plaphyCodeCol != -1)
     ...
     * Boolean success = new MrnPlapol1(
     *     Tables.INTNULL,
     *     <val2>,
     *     Tables.FLOATNULL,
     *     Tables.FLOATNULL,
     ...
     *  .e.g.<pre>
     * Boolean success
     * MrnPlapol1 plapol1 = new MrnPlapol1();
     * success = plapol1.del(MrnPlapol1.PLAPHY_CODE+"=<val1>");</pre>
     ...
     * update are taken from the MrnPlapol1 argument, .e.g.<pre>
     * Boolean success
     * MrnPlapol1 updMrnPlapol1 = new MrnPlapol1();
     * updMrnPlapol1.setArsenic(<val2>);
     * MrnPlapol1 whereMrnPlapol1 = new MrnPlapol1(<val1>);
     * success = whereMrnPlapol1.upd(updMrnPlapol1);</pre>
     * will update Arsenic to <val2> for all records where 
     * plaphyCode = <val1>.
     * @param plapol1  A MrnPlapol1 variable in which the fields are to be used for 
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnPlapol1 plapol1) {
        return db.update (TABLE, createColVals(plapol1), createWhere());
    } // method upd
     ...
     * MrnPlapol1 updMrnPlapol1 = new MrnPlapol1();
     * updMrnPlapol1.setArsenic(<val2>);
     * MrnPlapol1 whereMrnPlapol1 = new MrnPlapol1();
     * success = whereMrnPlapol1.upd(
     *     updMrnPlapol1, MrnPlapol1.PLAPHY_CODE+"=<val1>");</pre>
     * will update Arsenic to <val2> for all records where 
     * plaphyCode = <val1>.
     * @param  updMrnPlapol1  A MrnPlapol1 variable in which the fields are to be used for 
     *                 the update are set
     * @param  where  The where clause for the select statement. (String)
     * @return success = true/false (boolean)
     */
    public boolean upd(MrnPlapol1 plapol1, String where) {
        return db.update (TABLE, createColVals(plapol1), where);
    } // method upd
     ...
     */
    private String createColVals(MrnPlapol1 aVar) {
        String colVals = "";
