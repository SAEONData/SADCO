 ...
 */
public class ExtractMRNPhysNutDataODVNatmirc2 { //extends CompoundItem {
    ...
    /**
     * Main constructor ExtractMRNPhysNutDataODVNatmirc2
     * @param   args   String array of arguments as from form or URL
     */
    public ExtractMRNPhysNutDataODVNatmirc2(String args[])  {
    ...
    } // ExtractMRNPhysNutDataODVNatmirc2(String args[])
    ...
    int getDataRecords(MrnStation[] stations) {
        ...
        for (int i = 0; i < stations.length; i++) {
            ...
            //if (dbg)
            System.out.print("min, etopo2, max = " + depthMin + " " +
                etopo2Depth + " " + depthMax);
    ...
    void printRecords(MrnStation station, MrnWatphy watphy,
        ...
        // Print the BODY OF THE FILE
            ...
            nullToNULL(etopo2Depth,8,2)             +tab+
            ...
            nullToZERO(station.getStndep(),8,2);
            /*
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ExtractMRNPhysNutDataODVNatmirc2 local =
                new ExtractMRNPhysNutDataODVNatmirc2(args);
        } catch(Exception e) {
            common.edmCommonPC.processErrorStatic(
                e, "ExtractMRNPhysNutDataODVNatmirc2", "Constructor", "");
 ...
 }// class ExtractMRNPhysNutDataODVNatmirc2
