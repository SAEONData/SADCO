 ...
 * @version
 * 040909 - LoadVOSData2.java replace the LoadVOSData.java                  <br>
 * 041130 - ub01 - fix up testing for database                              <br>
 */
public class LoadVOSData2 extends CompoundItem {
    ...
    */
    ...
    public LoadVOSData2(String args[]) {

        if (dbg) System.out.println("<br>LoadVOSData2: before getParms");
        // get the argument values
        getArgParms(args);

        if (dbg) System.out.println("<br>LoadVOSData2: After getParms");
    ...
    void processInputFile() {
        ...
        while(!ec.eof(lfile)) {
            ...
            recordCount++;
            if (line.length() >= 125) {
                if (dbg) System.out.println("<br>processInputFile: line = " + line);
                readErrorFlag = false;
                ...
                if (!readErrorFlag) {
                    if (dbg) System.out.println("processInputFile: readErrorFlag check "+readErrorFlag);
    ...
    void readData() {
        ...
        if (dbg) System.out.print("<br>readData: callsign = " + callsign);
        ...
        if (dbg) System.out.print("<br>readData: clht  = " + clht);
        ...
        if (dbg) System.out.print("<br>readData: sts  = " + sts );
...
//        if ((intQ == 1) || (intQ  == 7)) max = 10; // north
        ...
        testno2 = testReadErrorValue(latinS+latin, min, max, "LATIN  ",
...
//        if ((intQ == 5) || (intQ  == 7)) max = 30;  // west
        ...
        // LONGITUDE - if quadrant is west (Q=5 or 7) the value must be -ve
        loninS = "";
        if ((intQ == 5) || (intQ == 7)) { // west
            loninS = "-";
        } // if ((intQ == 5) || (intQ == 7))
        ...
        */
        ...
        min = min * 10;
        max = max * 10;
        testno2 = testReadErrorValue(loninS+longin, min, max, "LONGIN ",
    ...
    void processRest(VosTable data) {
        ...
        if (dbg) System.out.println("<br>processRest: **?** dum "+dum);
        if (dbg) System.out.println("<br>processRest: **?** testno "+testno);

        if ((!"0".equals(dum) && !"9".equals(dum)) || (testno == EVAL)) {
            setTempErrorFlags("SLP    ", slp, "Invalid sea-level pressure ("+position+")");
        } // if ((!"0".equals(dum) && !"9".equals(dum)) || (testno == EVAL)) {
   ...
   /**
    ...
    public static void main(String args[]) {
        ...
        try {
            LoadVOSData2 local= new LoadVOSData2(args);
        } catch(Exception e) {
            //ec.processErrorStatic(e, "LoadVOSData2", "Constructor", "");
            e.printStackTrace();
