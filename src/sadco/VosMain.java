//+------------------------------------------------+----------------+--------+
//| CLASS: ....... VosMain                         | JAVA PROGRAM   | 001120 |
//+------------------------------------------------+----------------+--------+
//| PROGRAMMER: .. SIT Group                                                 |
//+--------------------------------------------------------------------------+
//| Description                                                              |
//| ===========                                                              |
//| The class that handles the VOS_MAIN table.                               |
//|                                                                          |
//+--------------------------------------------------------------------------+
//| History                                                                  |
//| =======                                                                  |
...
/**
 * This class manages the VOS_MAIN table with the help of the DbAccessC
 * class.   It has <b>get, put, del</b> and <b>upd</b> methods to <b>select,
 * insert, delete</b> and <b>update</b> the table.
 */
public class VosMain extends VosTable {
    ...
    /** The table name */
    //public static final String TABLE = "VOS_MAIN";
    ...
    public VosMain() {
        ...
        TABLE = "VOS_MAIN";
        //clearVars();
        if (dbg) System.out.println ("<br>in VosMain constructor 1"); // debug
    } // VosMain constructor

    /**
     * Instantiate a VosMain object and initialize the instance variables.
    ...
    public VosMain(
        ...
        if (dbg) System.out.println ("<br>in VosMain constructor 2"); // debug
    } // VosMain constructor
    ...
    public VosMain(
        ...
        TABLE = "VOS_MAIN";
        if (dbg) System.out.println ("<br>in VosMain constructor 3"); // debug
    } // VosMain constructor
     ...
     * are returned in an array of VosMain. e.g.<pre>
     * VosMain vosMain = new VosMain(<val1>);
     * VosMain vosMainArray[] = vosMain.get();</pre>
     * will get the VosMain record where latitude = <val1>.
     * @return Array of VosMain (VosMain[])
     */
    public VosMain[] get() {
     ...
     * e.g.<pre>
     * VosMain vosMainArray[] =
     *     new VosMain().get(VosMain.LATITUDE+"=<val1>");</pre>
     * will get the VosMain record where latitude = <val1>.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     * @return Array of VosMain (VosMain[])
     */
    public VosMain[] get (String where) {
     ...
     * VosMain vosMainArray[] =
     *     new VosMain().get("1=1",vosMain.LATITUDE);</pre>
     * will get the all the VosMain records, and order them by latitude.
     * @param  where  The where clause for the select statement. (String)
     *     If where == "" / null, it is ignored.
     ...
     * @return Array of VosMain (VosMain[])
     */
    public VosMain[] get (String where, String order) {
     ...
     * String columns = VosMain.LATITUDE,VosMain.LONGITUDE;
     * String where = VosMain.LATITUDE + "=<val1";
     * String order = VosMain.LATITUDE;
     * VosMain vosMainArray[] =
     *     new VosMain().get(columns, where, order);</pre>
     * will get the latitude and longitude colums of all VosMain records,
     ...
     * @return Array of VosMain (VosMain[])
     */
    public VosMain[] get (String fields, String where, String order) {
        // create the column list from the instance variables if neccessary
        if (dbg) System.out.println("VosMain: get: fields = " + fields);
        try {
     ...
     *  .e.g.<pre>
     * Boolean success
     * VosMain vosMain = new VosMain();
     * success = vosMain.del(VosMain.LATITUDE+"=<val1>");</pre>
     ...
     * update are taken from the VosMain argument, .e.g.<pre>
     * Boolean success
     * VosMain updVosMain = new VosMain();
     * updVosMain.setLongitude(<val2>);
     * VosMain whereVosMain = new VosMain(<val1>);
     * success = whereVosMain.upd(updJobs);</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  vosMain  A VosMain variable in which the fields are to be used for
     *                 the update are set
     * @return success = true/false (boolean)
     */
    public boolean upd(VosMain vosMain) {
        return doUpd(TABLE, vosMain, createWhere());
    } // method upd
     ...
     * success = whereVosMain.upd(
     *     updVosMain, VosMain.LATITUDE+"=<val1>");</pre>
     * will update Longitude to <val2> for all records where
     * latitude = <val1>.
     * @param  vosMain  A VosMain variable in which the fields are to be used for
     *                 the update are set
     ...
     * @return success = true/false (boolean)
     */
    public boolean upd(VosMain vosMain, String where) {
        return doUpd(TABLE, vosMain, where);
    } // method upd
    ...
    /**
     * converts the VosTables array to a VosMain array
     */
    VosMain[] cvt2Local (VosTable[] ct) {
        VosMain[] local = new VosMain[ct.length];
