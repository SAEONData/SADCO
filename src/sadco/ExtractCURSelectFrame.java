 ...
 */
public class ExtractCURSelectFrame extends CompoundItem {
     ...
     */
    public ExtractCURSelectFrame (String args[]) {

        try {
            ExtractCURSelectFrameActual(args);
        } catch(Exception e) {
            ec.processError(e, this.getClass().getName(), "constructor", "");
        } // try - catch

    } // ExtractCURSelectFrame constructor

    /**
    * Creates a page with a banner and an entry form
    * @param args the string array of url-type name-value parameter pairs
    */
    void ExtractCURSelectFrameActual(String args[]) {
...
//            "If 'Physical/Nutrient Oceanography', please specify format.",2));
//        formTable.addRow(ec.cr2ColRow("Data Format :", value));
        ...
        /*****************/
        Form form = new Form("POST\" name=\"myForm", sc.CUR_APP, target);
    ...
    } // ExtractCURSelectFrameActual

} // ExtractCURSelectFrame class
