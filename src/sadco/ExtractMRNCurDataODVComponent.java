 ...
 * 150316 - Ursula von St Ange - create from ExtractMRNCurDataODV (ub07)    <br>
 */
public class ExtractMRNCurDataODVComponent {
    ...
    /**
     * Main constructor ExtractMRNCurDataODVComponent
     * @param   args   String array of arguments as from form or URL
     */
    public ExtractMRNCurDataODVComponent(String args[])  {
...
//        printHeader();
    ...
    } // ExtractMRNCurDataODVComponent(String args[])
...
//        for (int i = 1; i < 5; i++) {
            ...
            if (dbg) System.out.println("CalcBearings: lon1, lon2 =" +
                ec.frm(stations[i-1].getLongitude(),10,5) +
            ...
            if (dbg) System.out.println("CalcBearings: lat1, lat2 =" +
                ec.frm(lat1,10,5) + ec.frm(lat2,10,5));
            if (dbg) System.out.println("CalcBearings: lon1, lon2 =" +
                ec.frm(lon1,10,5) + ec.frm(lon2,10,5));
            ...
            if (dbg) System.out.println("CalcBearings: dlat, dlon = " +
                ec.frm(dlat,10,5) + " " + ec.frm(dlon,10,5));
...
//            for (int i = 1; i < 5; i++)
    ...
    void printRecords(MrnStation station, float bearing, String bearingIndicator, //ub07
        ...
        if (dbg) System.out.println("printRecords: bearingIndicator = " + bearingIndicator);
        ...
        String sub = currents.getSubdes();
        if ("adcp".equalsIgnoreCase(sub)) {
            sub = "A";
        } else if ("curr".equalsIgnoreCase(sub)) {
            sub = "C";
        } else if ("hydroson".equalsIgnoreCase(sub)) {
            sub = "H";
        } else {
            sub = "*";
        } //if ("adcp".equalsIgnoreCase(sub))
...
*/
        ...
        ec.frm(station.getStationId()+bearingIndicator,13) +tab+       //ub04 ub07
        ec.frm(sub,5)                               +tab+
        month+"/" +day+"/"+ year                    +tab+
        ftime.trim()                                +tab+
        ...
        nullToNULL(currents.getSpldep(),8,2)        +tab+
        nullToNULL(bearing,8,2)                     +tab+               //ub07
        nullToNULL(vCross,8,4)                      +tab+               //ub07
        currents.getPercGood("")                    +tab+
...
/*
    void ColumnHeadings() {
        ...
        String head = "  LATDEG,  LONDEG, YEAR, MONTH, DEPTH,DAY, TIME   ,"+
                      ...
                      "MXSPLDEP, STN NAM     , SURVEYID   , PLANAM                , " +
...
*/
    ...
    void ColumnHeadings() {
        ...
        head =
            ...
            "Ship Bearing [deg TN]\tCross-Bearing Current Component\tPercent Good [%]\t"+
            "Deepest Obs. Depth [m]";
        ec.writeFileLine(ofile,head);
...
*/
    ...
    LogUsers createLogUsers(String userid, Timestamp start, String timeDiff) {//ub04
        ...
        logs.setDiscipline("curodvcomp");                               //ub04 ub07
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ExtractMRNCurDataODVComponent local =
                new ExtractMRNCurDataODVComponent(args);
        } catch(Exception e) {
            common.edmCommonPC.processErrorStatic(
                e, "ExtractMRNCurDataODVComponent", "Constructor", "");
        } // try-catch
 ...
 }// class ExtractMRNCurDataODVComponent
