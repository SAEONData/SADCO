 ...
 * special for Marten - only do stations for a range of survey ID's
 *
 * SadcoMRN
 ...
 */
public class ExtractMRNPhysNutDataODVmlg { //extends CompoundItem {
    ...
    /**
     * Main constructor ExtractMRNPhysNutDataODVmlg
     * @param   args   String array of arguments as from form or URL
     */
    public ExtractMRNPhysNutDataODVmlg(String args[])  {
...
//        updateLogUsers(log, ec.timeDiff(endJDate, endQDate));           //ub04
    ...
    } // ExtractMRNPhysNutDataODVmlg(String args[])
    ...
    MrnStation[] getStationRecords() {
        ...
        String where = MrnStation.SURVEY_ID + " between '2013/0001' and '2013/0345'";
/*
        if (!"".equals(surveyId)) {
...
//        } //
        ...
        Timestamp dateT = station.getDateStart();
...
*/
    ...
    public static void main(String args[]) {
        ...
        try {
            ExtractMRNPhysNutDataODVmlg local =
                new ExtractMRNPhysNutDataODVmlg(args);
        } catch(Exception e) {
            common.edmCommonPC.processErrorStatic(
                e, "ExtractMRNPhysNutDataODVmlg", "Constructor", "");
 ...
 }// class ExtractMRNPhysNutDataODVmlg
