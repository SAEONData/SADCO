 ...
 *                               change name from LoadMRNFrame to
 *                               LoadMRNWatFrame                            <br>
 */
public class LoadMRNWatFrame extends CompoundItem {
     ...
     */
    public LoadMRNWatFrame (String args[]) {

        try {
            LoadMRNWatFrameActual(args);
        } catch(Exception e) {
            ec.processError(e, this.getClass().getName(), "constructor", "");
        } // try - catch

    } // LoadMRNWatFrame constructor
     ...
     * @param args the string array of url-type name-value parameter pairs
     */
    void LoadMRNWatFrameActual(String args[]) {
        ...
        if (dbg) System.err.println("** LoadMRNWatFrame command = " + command);
    ...
    public static void main(String args[]) {
        ...
        try {
            HtmlHead hd = new HtmlHead("LoadMRNWatFrame local");
            ...
            ec.processErrorStatic(e, "LoadMRNWatFrame", "Constructor", "");
