...
*/
public class SadcoCUR extends HttpServlet {
    ...
    static String thisClass   = "SadcoCUR"; // class name
    static String headTitle   = "SadcoCUR"; // title in head part of page
...
/*
    public static void main(String args[]) {
        try {
            SadcoCur local= new SadcoCur(args);
        } catch(Exception e) {
